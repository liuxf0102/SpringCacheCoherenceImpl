 ...
 * @since 3.1
 */
public class MyMapCacheFactoryBean
		implements FactoryBean<MyMapCache>, BeanNameAware, InitializingBean {
	...
	public void afterPropertiesSet() {
		this.cache = (this.store != null ? new MyMapCache(this.name, this.store, this.allowNullValues) :
				new MyMapCache(this.name, this.allowNullValues));
	}


	@Override
	public MyMapCache getObject() {

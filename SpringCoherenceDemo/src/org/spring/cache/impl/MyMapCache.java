 ...
 * @since 3.1
 */
public class MyMapCache extends AbstractValueAdaptingCache {
	 ...
	 */
	public MyMapCache(String name, boolean allowNullValues) {
	 ...
	 */
	public MyMapCache(String name, ConcurrentMap<Object, Object> store, boolean allowNullValues) {
